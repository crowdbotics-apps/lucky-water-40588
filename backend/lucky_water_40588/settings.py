"""
Django settings for lucky_water_40588 project.
...
ROOT_URLCONF = 'lucky_water_40588.urls'
...
WSGI_APPLICATION = 'lucky_water_40588.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_water_40588 API",
    "DESCRIPTION": "API documentation for lucky_water_40588 App",
    "VERSION": "v1",
}
